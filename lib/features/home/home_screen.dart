...
import 'package:cryptid/features/backup/backup_screen.dart';
                          ...
                          PopupMenuItem(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) {
                                    state.fileContent.properties ??= PropertiesModel(backup: []);
                                    final backupCopy = List<BackupValue>.from(state.fileContent.properties!.backup);
                                    return BlocProvider.value(
                                      value: context.read<StorageCubit>(),
                                      child: BackupScreenWidget(
                                        backup: backupCopy,
                                        filePath: state.filePath!,
                                      ),
                                    );
                            ...
                            child: ListTile(
                              ...
                              mouseCursor: MouseCursor.defer,
                              trailing: state.fileContent.properties!.backup.isNotEmpty
                                  ? Badge(
                                      label: Text('${state.fileContent.properties!.backup.length}'),
